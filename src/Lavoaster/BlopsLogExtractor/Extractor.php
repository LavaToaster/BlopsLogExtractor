    ...
    private function parseEvent($line)
    {
        ...
        if ($type == 'K') {
            $data = [
                'type' => 'kill',
                'data' => [
                    'victim_player_id' => $line[1],
                    'victim_player_slot' => $line[2],
                    'victim_player_team' => $line[3],
                    'victim_player_name' => $line[4],
                    'attack_player_id' => $line[5],
                    'attack_player_slot' => $line[6],
                    'attack_player_team' => $line[7],
                    'attack_player_name' => $line[8],
                    'weapon' => $line[9],
                    'damage' => $line[10],
                    'type' => $line[11],
                    'target_area' => $line[12],
